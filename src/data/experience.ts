...
export const experience: ExperienceEntry[] = [
  {
    ...
    summary:
      "Led the front-end build of two of GoCardless's most-requested features — Protect+ and the Merchant Dashboard Reporting suite — with a measurable lift in NPS scores. Currently leading front-end work on GoCardless for Xero (GC4X), migrating it off legacy frameworks onto Next.js — cutting delivery timelines by over 55% and front-end-related support queries by half, with one migration shipped in 5 weeks instead of the usual 12, the fastest delivered to date. Introduced a standardised QA test-case framework, started a self-review habit on PRs since adopted team-wide, and patched several high-severity security vulnerabilities before they could be exploited.",
  ...
  },
  {
    ...
    summary:
      "Partnered with design on a full web and mobile reskin, building a shared component library that improved consistency and sped up delivery for the whole front-end team, and ran A/B tests on copywriting that helped inform content strategy and increase engagement.",
