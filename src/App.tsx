...
import {NoStyleAnchor, Heading, SubHeading, Para, ProfileImage, Image, FooterLink, Flex} from "./components/Section/styled"
    ...
    <div className="app">
      ...
      <Section id="experience" heading="A few things I've worked on...">
        ...
        <Flex responsive alignItems="center" margin="60px 0">
          ...
          <Para marginLeft="20px"><h4>Mark perk as used: </h4><br />A feature requested by customers to mark redeemed perks as 'used' as a way to organise their redemption history. </Para>
        </Flex>
        <Flex responsiveReverse alignItems="center">
          <Para marginRight="20px"><h4>Open / fixed voucher redemptions: </h4><br />The ability to redeem open value gift vouchers for users who don't want to select from the provided denominations.<br /><br />
